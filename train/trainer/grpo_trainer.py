...
from transformers.masking_utils import create_causal_mask, eager_mask, _preprocess_mask_arguments, causal_mask_function
...
def TextModelNeoforward(
    ...
    **kwargs: Unpack[FlashAttentionKwargs],
    ...
    eager_attention_mask = create_causal_mask_special(
        config=self.config,
